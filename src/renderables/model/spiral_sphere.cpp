...
std::shared_ptr<vulkan::RenderingPipeline> renderable::SpiralSphere::CreatePipeline(
...
size_t renderable::SpiralSphere::NumOfIndicesToDraw() { return sphere_->GetIndexCount(); }
renderable::SpiralSphere::~SpiralSphere() { WaitForCommandBuffersToFinish(); }
