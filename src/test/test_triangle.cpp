...
test::TestTriangle::TestTriangle(std::shared_ptr<api::Renderer> renderer) : TestModel(std::move(renderer)) {
...
void test::TestTriangle::OnClear() {
...
void test::TestTriangle::OnViewportChange() {
