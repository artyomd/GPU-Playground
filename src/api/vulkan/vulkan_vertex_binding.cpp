...
api::vulkan::VulkanVertexBinding::VulkanVertexBinding(std::shared_ptr<api::VertexBuffer> vb,
...
const VkVertexInputBindingDescription *api::vulkan::VulkanVertexBinding::GetVertexInputBindingDescription() const {
  return &vertex_input_binding_description_;
}
const std::vector<VkVertexInputAttributeDescription> *api::vulkan::VulkanVertexBinding::GetAttributeDescriptions() const {
  return &attribute_descriptions_;
}
void api::vulkan::VulkanVertexBinding::Bind() const {
  buffer_->Bind();
}
void api::vulkan::VulkanVertexBinding::Unbind() const {
  buffer_->Unbind();
}
