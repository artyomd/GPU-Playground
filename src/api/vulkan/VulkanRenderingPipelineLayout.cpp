...
api::VulkanRenderingPipelineLayout::VulkanRenderingPipelineLayout(std::shared_ptr<VulkanRenderingContext> context,
...
VkPipelineLayout api::VulkanRenderingPipelineLayout::GetPipelineLayout() const {
  return pipeline_layout_;
}

void api::VulkanRenderingPipelineLayout::Bind() const {
...
api::VulkanRenderingPipelineLayout::~VulkanRenderingPipelineLayout() {
