...
api::VulkanUniformBuffer::VulkanUniformBuffer(std::shared_ptr<VulkanRenderingContext> context,
...
VkDescriptorSetLayoutBinding api::VulkanUniformBuffer::GetLayoutBinding() const {
...
VkWriteDescriptorSet api::VulkanUniformBuffer::GetWriteDescriptorSetFor(int image_index) const {
...
void api::VulkanUniformBuffer::Update(const void *data) {
...
api::VulkanUniformBuffer::~VulkanUniformBuffer() {
