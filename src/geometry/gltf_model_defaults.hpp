...
static const std::map<std::string, ExpectedValues> kPrimitiveTypes{
    {"INDICES",
     {.element_count = {TINYGLTF_TYPE_SCALAR},
      .element_type = {TINYGLTF_COMPONENT_TYPE_UNSIGNED_BYTE, TINYGLTF_COMPONENT_TYPE_UNSIGNED_SHORT,
    ...
    {"TEXCOORD_0",
     {.element_count = {TINYGLTF_TYPE_VEC2},
      .element_type = {TINYGLTF_COMPONENT_TYPE_FLOAT, TINYGLTF_COMPONENT_TYPE_UNSIGNED_BYTE,
    ...
    {"TEXCOORD_1",
     {.element_count = {TINYGLTF_TYPE_VEC2},
      ...
      .target = TINYGLTF_TARGET_ARRAY_BUFFER}},
    {"COLOR_0",
     {.element_count = {TINYGLTF_TYPE_VEC3, TINYGLTF_TYPE_VEC4},
      .element_type = {TINYGLTF_COMPONENT_TYPE_FLOAT, TINYGLTF_COMPONENT_TYPE_UNSIGNED_BYTE,
                       TINYGLTF_COMPONENT_TYPE_UNSIGNED_SHORT},
      .target = TINYGLTF_TARGET_ARRAY_BUFFER}},
    {"JOINTS_0",
