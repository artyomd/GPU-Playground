 ...
 * License. Contact: tdmaav@gmail.com
 */
...
#define EPSILON_NRM (0.1 / u_screenSize.x)
...
void main() {
  ...
  // ray
  vec3 ang = vec3(0);  // vec3(sin(time*3.0)*0.1,sin(time)*0.2+0.3,time);
  ...
  // post
  out_color = vec4(pow(color, vec3(0.75)), 1.0);
}
